...
@include('crud::fields.inc.wrapper_start')
    ...
    <select
        ...
        style="width: 100%"
        data-init-function="bpFieldInitGoogleFontsElement"
        @include('crud::fields.inc.attributes', ['default_class' =>  'form-control font_picker'])
        ...
        <?php
            if(!isset($field['options'])){
                $field['options'] = config('backpack.font-picker-field-for-backpack.fonts', []);
            }
            if(array_values($field['options']) === $field['options']){
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @endif
    <script>
        function bpFieldInitGoogleFontsElement(element) {
                    ...
                    element
                        .select2({
                            ...
                            templateResult: function (opt) {
                                ...
                                return $('<span style="font-family:\'' + opt.element.value + '\';"> ' + opt.text + '</span>');
                            },
                        })
